...
public class VersionOne {
    ...
    public Boolean setup(){
        ...
        final String schema = "CREATE SCHEMA search AUTHORIZATION admin\n" +
                "CREATE TABLE IF NOT EXISTS links ( dir VARCHAR(255), links INTEGER )\n" +
                ...
                "other BOOLEAN, hidden BOOLEAN, groups VARCHAR(255), owner VARCHAR(255), permissions INTEGER, hash VARCHAR(255) )\n" +

...
public class VersionOne {
    ...
    public Boolean setup(){
        ...
        final String schema = "CREATE SCHEMA search AUTHORIZATION admin\n" +
                ...
                "CREATE TABLE IF NOT EXISTS state ( url VARCHAR(255), mtime INTEGER, atime INTEGER, group_name INTEGER, owner INTEGER, permissions INTEGER, changes )\n" +
                ...
                "other BOOLEAN, hidden BOOLEAN, group_name VARCHAR(255), owner VARCHAR(255), permissions INTEGER, hash VARCHAR(255) )\n" +

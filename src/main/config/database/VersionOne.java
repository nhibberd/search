...
public class VersionOne {
    ...
    public Boolean setup(){
        ...
        final String schema = "CREATE SCHEMA search AUTHORIZATION admin\n" +
                ...
                "CREATE TABLE IF NOT EXISTS file ( id INTEGER PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, name VARCHAR(255), ext VARCHAR(255), mtime BIGINT, ctime BIGINT, atime BIGINT, url VARCHAR(255), hash VARCHAR(255) )\n" +

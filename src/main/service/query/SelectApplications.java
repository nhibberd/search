...
public class SelectApplications {
     ...
     */
    public String topApplication(final String query){
     ...
     */
    public List<String> listApplications(final String query){
    ...
    public List<String> listApplications(final String query, final Integer size){
        return connector.withConnection(new Function<Connection, List<String>>() {
            public List<String> apply(final Connection connection) {
